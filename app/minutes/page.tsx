        ...
        <div className="mb-6 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-xl p-4 shadow-sm">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <button
              ...
              className={`min-h-11 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${filter === 'all' ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-700 hover:bg-slate-200'}`}
            >
              Alle
            </button>
            <button
